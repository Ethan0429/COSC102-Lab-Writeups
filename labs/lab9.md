...
- `ignore()` - Useful for when you've read as much data as you wannt, and then need to ignore everything up to a certain character or just ignore the next character.
